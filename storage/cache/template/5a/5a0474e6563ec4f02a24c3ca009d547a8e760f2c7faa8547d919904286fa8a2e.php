...
class __TwigTemplate_c1b4ccb9fbb75b579ce9fb8e734752550177db9d47a1901f445fa26b3403b275 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t</div>
\t\t<div class=\"pop-left\">
\t\t\t<h2>У нас отображен не весь ассортимент товаров</h2>
\t\t\t<p>Если вы не нашли нужный товар в каталоге, Вы всегда можете с нами связаться любым удобным способом</p>
\t\t\t
\t\t\t<ul>
\t\t\t\t\t<li><a href=\"https://spbzveri.ru/contact\"><i class=\"icon icon-right-dir\"></i> Контакты и реквизиты</a></li>
...
\t\t\t\t\t<li><a href=\"#\"><i class=\"icon icon-location-1\"></i> Адрес: г. Санкт-Петербург, пр. Александровской фермы, 35 Лит Б</a></li>
\t\t\t\t\t<li>Магазин-склад (пн-пт) c 10-00 до 18-00
(Въезд с Софийской ул, 62А)</li>
\t\t\t\t</ul>
\t\t\t\t
\t\t</div>
\t\t
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["style"]) {
            // line 268
            echo "<link href=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "href", [], "any", false, false, false, 268);
            echo "\" type=\"text/css\" rel=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "rel", [], "any", false, false, false, 268);
            echo "\" media=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "media", [], "any", false, false, false, 268);
            echo "\" />
";
        }
        $_parent = $context['_parent'];
...
";
    ...
    {
        return array (  423 => 274,  420 => 273,  411 => 271,  407 => 270,  394 => 268,  390 => 267,  310 => 189,  306 => 187,  300 => 184,  292 => 179,  285 => 178,  274 => 176,  270 => 175,  264 => 174,  254 => 167,  250 => 166,  244 => 165,  237 => 164,  226 => 162,  222 => 161,  216 => 160,  201 => 147,  174 => 123,  167 => 119,  124 => 79,  92 => 50,  50 => 11,  39 => 2,  37 => 1,);
    }
