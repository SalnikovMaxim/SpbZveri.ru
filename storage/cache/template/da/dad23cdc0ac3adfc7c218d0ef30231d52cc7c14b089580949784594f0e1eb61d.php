...
class __TwigTemplate_34e19b575f69ef18f315579111af9bba0bd2fee1b800e51fe406ddd57d6914c9 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["fg"]) {
                    // line 189
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t<optgroup label=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["fg"], "name", [], "any", false, false, false, 189);
                    echo "\">
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    // line 190
                    $context['_parent'] = $context;
...
";
                    ...
                    if (($context["column"] == "price")) {
                        echo "var filter_special_price=\$('input[name=\\'filter_special_price\\']').val();if(filter_special_price){url+='&filter_special_price='+encodeURIComponent(filter_special_price);}";
                    }
                } elseif ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,                 // line 339
$context["val"], "filter", [], "any", false, false, false, 339), "type", [], "any", false, false, false, 339) == 1)) {
                    // line 340
                    echo "var filter_";
                    echo $context["column"];
...
";
                    ...
                    echo $context["column"];
                    echo ")";
                    echo ((($context["column"] == "category")) ? ((("+'&filter_sub_category=" . ((twig_get_attribute($this->env, $this->source, ($context["filters"] ?? null), "sub_category", [], "any", false, false, false, 341)) ? (twig_get_attribute($this->env, $this->source, ($context["filters"] ?? null), "sub_category", [], "any", false, false, false, 341)) : ("0"))) . "'")) : (""));
                    echo ";}
";
                }
            }
...
";
        ...
        $context['_seq'] = twig_ensure_traversable(($context["column_info"] ?? null));
        foreach ($context['_seq'] as $context["column"] => $context["val"]) {
            if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["val"], "filter", [], "any", false, false, false, 343), "autocomplete", [], "any", false, false, false, 343)) {
                // line 344
                echo "\$('input[name=\\'filter_";
                echo $context["column"];
...
";
                // line 345
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["val"], "filter", [], "any", false, false, false, 345), "autocomplete", [], "any", false, false, false, 345), "return", [], "any", false, false, false, 345));
        ...
        echo "\",event:\"";
        echo ($context["module_admin_quick_edit_quick_edit_on"] ?? null);
        echo "\",onblur:\"ignore\",placeholder:\"\"}),\$(\".cat_qe, .store_qe, .dl_qe, .filter_qe\").editable(function(e,t){return bull5i.quick_update(this,e,t,\"";
        echo ($context["update_url"] ?? null);
        ...
        echo "\",loadtype:\"POST\",loadtext:\"";
        echo ($context["text_loading"] ?? null);
        echo "\"}),\$(\".attr_qe,.dscnt_qe,.images_qe,.filters_qe,.option_qe,.recur_qe,.related_qe,.special_qe,.descr_qe,.dls_qe,.keyw_qe\").on(\"click\",function(e){e.preventDefault();var t=\$(this).attr(\"id\"),i=\$(this).attr(\"id\").split(\"-\")[1],l=\$(this).attr(\"id\").split(\"-\")[0],p={alerts:\$.merge(\$(\"#aqe-modal .notice\"),\$(\"#alerts\"))};bull5i.load_popup_data(\"";
        echo ($context["load_popup_url"] ?? null);
        ...
        echo ($context["update_url"] ?? null);
        echo "\",e).done(function(t){(t===!0||t.success)&&bull5i.update_related(l,\$.unique(\$.merge([i],e.ids||[]))),\$.isFunction(o)&&o.call(null,t)}).fail(function(e){\$.isFunction(o)&&o.call(null,e)})},\"modal-lg\")})}),\$(\".date_qe\").editable(function(e,t){return bull5i.quick_update(this,e,t,\"";
        echo ($context["update_url"] ?? null);
        ...
        echo "\",event:\"";
        echo ($context["module_admin_quick_edit_quick_edit_on"] ?? null);
        echo "\",onblur:\"cancel\",placeholder:\"\",select:!0}),\$(\".price_qe\").editable(function(e,t){return bull5i.quick_update(this,e,t,\"";
        echo ($context["update_url"] ?? null);
