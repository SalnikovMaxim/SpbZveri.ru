...
class __TwigTemplate_7c20a2ee77f000cf3ee9275ec385c160d16573837c7c6342ea20eb3274342c48 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["customer_group"]) {
                ...
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "name", [], "any", false, false, false, 276);
                echo "</option>';
\t";
            }
            $_parent = $context['_parent'];
