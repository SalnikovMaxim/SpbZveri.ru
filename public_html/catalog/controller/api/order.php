			...
			if (!$json) {
				...
				if ($this->cart->hasShipping()) {
					...
					$order_data['shipping_address_format'] = $this->session->data['shipping_address']['address_format'];
					 $order_data['delivery_datetime'] = $this->session->data['shipping_address']['delivery_datetime'];
				...
				if (!empty($this->session->data['membership_card_savings'])) {
					$card_info = $this->model_extension_total_membership_card->getCard($this->session->data['membership_card']);
					
					if ($card_info) {
						$this->model_extension_total_membership_card->unconfirm($json['order_id']);
						$this->model_extension_total_membership_card->reduceSavings($card_info['card_id'], $json['order_id'], $this->session->data['membership_card_savings']);
					}
				...
				if (!empty($this->session->data['membership_gift'])) {
					...
					$this->model_extension_total_membership_gift->unconfirm($json['order_id']);
					$this->model_extension_total_membership_gift->confirm($this->session->data['membership_gift'], $json['order_id']);
				...
				if (!$json) {
					...
					if (!empty($this->session->data['membership_card_savings'])) {
						...
						if ($card_info) {
							...
							$this->model_extension_total_membership_card->reduceSavings($card_info['card_id'], $order_id, $this->session->data['membership_card_savings']);
						}
					...
					if (!empty($this->session->data['membership_gift'])) {
						...
						$this->model_extension_total_membership_gift->confirm($this->session->data['membership_gift'], $order_id);
