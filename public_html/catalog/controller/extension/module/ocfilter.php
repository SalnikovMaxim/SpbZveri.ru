  ...
  use Helper;
    ...
    if ($this->config->get('module_ocfilter_show_selected') && $this->ocfilter->getOptionsGet()) {
      ...
      $data['show_options_limit'] = false;
		...
		$this->document->addScript('catalog/view/javascript/filter/nouislider.min.js');
		$this->document->addScript('catalog/view/javascript/filter/filter.js');
 
		return $this->load->view('extension/module/filter/module', $data);
	} 
