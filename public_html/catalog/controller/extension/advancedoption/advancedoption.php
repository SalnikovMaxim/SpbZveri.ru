...
class ControllerExtensionAdvancedoptionadvancedoption extends Controller {
	public function index() {
		...
		if($product_info){
			...
			foreach ($options ? $options : [] as $product_option_id => $product_option_value_id){
				...
				if($this->config->get('module_advancedoption_upc') && $this->config->get('module_advancedoption_upc_status')){
					$json['sku'] = (isset($option_data_query->row['sku']) ? $option_data_query->row['sku'] : '');
				}
				if($this->config->get('module_advancedoption_upc') && $this->config->get('module_advancedoption_upc_status')){
					$json['upc'] = (isset($option_data_query->row['upc']) ? $option_data_query->row['upc'] : '');
				}
				if($this->config->get('module_advancedoption_ean') && $this->config->get('module_advancedoption_ean_status')){
					$json['ean'] = (isset($option_data_query->row['ean']) ? $option_data_query->row['ean'] : '');
				}
				if($this->config->get('module_advancedoption_jan') && $this->config->get('module_advancedoption_jan_status')){
