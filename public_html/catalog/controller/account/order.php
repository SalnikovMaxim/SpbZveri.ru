...
class ControllerAccountOrder extends Controller {
	public function index() {
		...
		if (!$this->customer->isLogged() && empty($this->session->data['tracking_email'])) { 
		...
		foreach ($results as $result) {
			...
			$data['orders'][] = array(
				...
				'reorderhref'	=> $this->url->link('account/order/reorderall', 'order_id=' . $result['order_id'], true),
			);
		}
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['reorderall'] = $this->url->link('account/order/reorderall', 'order_id=' . $order_id, true);
