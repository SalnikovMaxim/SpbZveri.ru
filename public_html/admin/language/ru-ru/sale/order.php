...
$_['text_delivery_datetime']          = 'Дата и время доставки';
$_['text_delivery_date']          = 'Дата доставки';
$_['text_delivery_time']          = 'Время доставки';

/* Membership */
$_['button_membership_card_add']			 = 'Выдать карту';
$_['button_membership_card_apply_discount']  = 'Применить скидку';
$_['button_membership_card_remove_discount'] = 'Удалить скидку';
$_['button_membership_gift_add']			 = 'Выдать подарок';
$_['button_membership_gift_remove'] 		 = 'Удалить подарок';

$_['text_membership']			 			 = 'Клубная программа';
$_['text_membership_card'] 				 	 = 'Клубная карта';
$_['text_membership_card_request']			 = 'Запрос клубной карты';
$_['text_membership_card_approve']			 = 'Утвердить клубную карту?';
$_['text_membership_card_issuance']			 = 'Выдать клиенту';
$_['text_membership_card_code']				 = 'Код';
$_['text_membership_gift'] 				 	 = 'Подарок';
$_['text_membership_gift_name'] 			 = 'Название';
