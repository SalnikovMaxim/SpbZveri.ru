...
class ControllerExtensionShippingFree extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['shipping_free_maps'])) {
			$data['shipping_free_maps'] = $this->request->post['shipping_free_maps'];
		} else {
			$data['shipping_free_maps'] = $this->config->get('shipping_free_maps');
		}
