	...
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
		  ...
		  // OCFilter end
			...
			if ($this->user->hasPermission('access', 'extension/module/ap_product_update')) {
				$catalog[] = array(
			...
			if ($this->user->hasPermission('access', 'catalog/articles')) {
				$catalog[] = array(
					'name'	   => 'Статьи',
			...
			/* Membership */
			if ($this->user->hasPermission('access', 'extension/module/membership') && $this->config->get('module_membership_status')) {		
				$marketing[] = array(
					'name'	   => $this->language->get('text_membership'),
					'href'     => $this->url->link('extension/module/membership', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}				
			/* Membership */
