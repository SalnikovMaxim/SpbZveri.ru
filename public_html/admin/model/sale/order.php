...
class ModelSaleOrder extends Model {
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'delivery_datetime'              => $order_query->row['delivery_datetime'],
	 ...
	 public function updateDeliveryDatetime($order_id, $datetime) {
        $this->db->query("UPDATE `" . DB_PREFIX . "order` SET delivery_datetime = '" . $datetime . "', date_modified = NOW() WHERE order_id = '" . (int)$order_id . "'");
    }
	 
	public function getOrders($data = array()) {
		$sql = "SELECT o.order_id, CONCAT(o.firstname, ' ', o.lastname) AS customer, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS order_status, o.shipping_code, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified, o.delivery_datetime FROM `" . DB_PREFIX . "order` o";
	...
	public function getOrderProducts($order_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_product o LEFT JOIN " . DB_PREFIX . "product op ON (o.product_id = op.product_id) WHERE order_id = '" . (int)$order_id . "'");
